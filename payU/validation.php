 ...
 * - Remember to set PAYU_SERVER to LIVE for production/live site
 */
// General defines
define( 'PAYU_SERVER', 'TEST' );
...
define( 'PF_ERR_CONNECT_FAILED', 'Failed to connect to PAYU' );
...
// Notify PAYU that information has been received
...
$output = ''; // DEBUG
$pfParamString = '';
$pfHost = ( PAYU_SERVER == 'LIVE' ) ?
	'www.payU.co.za' : 'sandbox.payU.co.za';
...
if( !$pfError )
{
    // Get the response from PAYU (VALID or INVALID)
    $result = trim( $lines[0] );
